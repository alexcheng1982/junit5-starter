...
public class SlowTestExecutionCondition implements ExecutionCondition {
  ...
  public ConditionEvaluationResult evaluateExecutionCondition(final ExtensionContext context) {
    if (Objects.isNull(System.getProperty("slow")) && context.getTags().contains("slow")) {
      return ConditionEvaluationResult.disabled("slow tests are disabled unless -Dslow is set");
    }
